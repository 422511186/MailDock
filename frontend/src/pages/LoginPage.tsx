...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 p-4 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 flex items-center justify-center gap-3">
          ...
          <span className="text-2xl font-bold text-slate-800 dark:text-slate-100">MailDock</span>
        </div>

        {/* 登录卡片 */}
        <div className="rounded-3xl border border-slate-200/80 bg-white/95 p-10 shadow-2xl shadow-slate-300/50 backdrop-blur-sm dark:border-slate-800/80 dark:bg-slate-900/95 dark:shadow-black/40">
          <h2 className="mb-8 text-center text-2xl font-bold text-slate-800 dark:text-slate-100">登录</h2>
          ...
          {mode === 'choice' ? (
            <div className="space-y-4">
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-3 rounded-2xl border-2 border-slate-200 bg-white px-6 py-4 text-base font-medium text-slate-700 transition hover:border-slate-300 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:border-slate-600 dark:hover:bg-slate-700"
              >
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-base">
                  <span className="bg-white px-4 text-slate-500 dark:bg-slate-900 dark:text-slate-400">或</span>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    className="w-full rounded-lg border border-slate-200 py-2.5 pl-10 pr-4 text-sm text-slate-800 transition focus:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:focus:border-emerald-500 dark:focus:ring-emerald-900/40"
                  />
                </div>
              </div>
              <div>
              ...
              {error && (
                <p
                  className="flex items-center gap-2 text-sm text-rose-600 animate-slide-down dark:text-rose-400"
                  role="alert"
                >
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-1.5 text-sm font-medium text-slate-500 transition hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200"
              >
